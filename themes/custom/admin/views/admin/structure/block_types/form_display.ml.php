...
<div class="border-b border-gray-200 mb-6">
    <nav class="-mb-px flex gap-8" aria-label="Tabs">
        ...
        <a href="/admin/structure/block-types/{{ $type['id'] }}/form-display"
        ...
        <a href="/admin/structure/block-types/{{ $type['id'] }}/display"
           class="border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 group inline-flex items-center border-b-2 py-4 px-1 text-sm font-medium">
...
<form action="/admin/structure/block-types/{{ $type['id'] }}/form-display" method="POST">
    ...
    <div class="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl md:col-span-2 mb-6 field-sortable-container"
         data-reorder-url="/admin/structure/block-types/{{ $type['id'] }}/form-display"
         data-context="form">
        <div class="px-4 py-6 sm:px-6">
            <div class="text-sm text-gray-500 mb-4 flex items-center gap-2">
                Drag and drop rows to reorder fields in the form editor.
