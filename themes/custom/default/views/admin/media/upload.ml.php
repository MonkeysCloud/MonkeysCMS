...
<div x-data="mediaUpload()" class="max-w-4xl mx-auto">
    ...
    <div x-show="uploads.length > 0" class="mt-8 space-y-4" x-transition>
        <div class="flex justify-between items-center mb-4">
            ...
            <span class="text-sm text-gray-500" x-text="completedCount + '/' + uploads.length + ' completed'"></span>
        </div>
                    ...
                    <div class="flex justify-between mt-1">
                        <span class="text-xs" :class="{
                         ...
                         <template x-if="file.status === 'uploading'">
                             <button @click="cancelUpload(file.id)" class="text-xs text-red-500 hover:text-red-700">Cancel</button>
                         </template>
                    </div>
                </div>
            </div>
