...
@section('content')
{{-- Sub-nav tabs --}}
<div class="ct-subnav mb-4" style="display:flex;gap:0.25rem;background:rgba(255,255,255,0.03);border-radius:0.5rem;padding:0.25rem;">
  <a href="/admin/content-types/{{ $contentType->type_id }}/edit"
     style="display:flex;align-items:center;gap:0.4rem;padding:0.5rem 1rem;border-radius:0.375rem;font-size:0.85rem;color:#94a3b8;text-decoration:none;">
    <i data-lucide="settings" class="w-4 h-4"></i> Settings
  </a>
  <a href="/admin/content-types/{{ $contentType->type_id }}/fields"
     style="display:flex;align-items:center;gap:0.4rem;padding:0.5rem 1rem;border-radius:0.375rem;font-size:0.85rem;color:#a5b4fc;background:rgba(99,102,241,0.15);font-weight:600;text-decoration:none;">
    <i data-lucide="list" class="w-4 h-4"></i> Fields
  </a>
  <a href="/admin/content-types/{{ $contentType->type_id }}/ai"
     style="display:flex;align-items:center;gap:0.4rem;padding:0.5rem 1rem;border-radius:0.375rem;font-size:0.85rem;color:#94a3b8;text-decoration:none;">
            ...
            <tr data-field-id="{{ $field->id }}" class="field-row">
              ...
              <td class="table__actions">
                <form action="/admin/content-types/{{ $contentType->type_id }}/fields/{{ $field->id }}/delete"
                      ...
                      data-confirm="Remove field {{ $field->name }}?" data-confirm-title="Remove Field">
